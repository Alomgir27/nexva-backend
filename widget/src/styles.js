export const Styles = {
  inject: function(config) {
    ...
    style.textContent = `
      ...
      .nexva-resize-handle { position: absolute; left: 0; top: 0; bottom: 0; width: 6px; cursor: ew-resize; background: transparent; z-index: 10; transition: background 0.2s ease; }
      .nexva-resize-handle:hover { background: ${primaryColor}40; }
      .nexva-resize-handle::before { content: ''; position: absolute; left: 2px; top: 50%; transform: translateY(-50%); width: 2px; height: 40px; background: ${borderColor}; border-radius: 2px; }
      ...
      .nexva-chat-message-content { max-width: 75%; padding: 12px 16px; border-radius: 12px; font-size: 14px; line-height: 1.6; word-wrap: break-word; overflow-wrap: break-word; }
